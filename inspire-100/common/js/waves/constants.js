...
const VC_WAVE_PRESSURE_FILTER_WINDOW = 1;
const VC_WAVE_FLOW_FILTER_WINDOW = 4;
const PS_WAVE_PRESSURE_FILTER_WINDOW = 4;
const PS_WAVE_FLOW_FILTER_WINDOW = 4;
const SAMPLE_FLOWQ_THRESHOLD = 0;
const WAVE_UNKNOWN_DATAPOINT = -32768;
