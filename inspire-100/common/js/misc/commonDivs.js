...
function initCommonDivElements() {
  ...
  dscompDIV = document.getElementById("DSCOMP");
  ...
  dscompValELM = document.getElementById("DSCOMP");
  ...
  psRampValELM = document.getElementById("PsRamp");
