...
const WAVE_MAX_SAMPLES_PER_BREATH = 60
const WAVE_MAX_SAMPLES_PER_SLICE = 6;
const WAVE_MAX_SLICES = 10;
const WAVE_HORIZONTAL_GRID_COLOR = '#8F99FB';
const WAVE_PRESSURE_FILTER_WINDOW = 6;
const WAVE_FLOW_FILTER_WINDOW = 6;
const SAMPLE_FLOWQ_THRESHOLD = 8;
