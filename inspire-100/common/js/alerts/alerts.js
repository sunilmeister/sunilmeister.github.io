...
function formAlertMessageStr(json) {
  let str = "";
  if (isDefined(json.L1) && (json.L1 !== null)) str += json.L1;
  if (isDefined(json.L2) && (json.L2 !== null)) str += "\n" + json.L2;
  if (isDefined(json.L3) && (json.L3 !== null)) str += "\n" + json.L3;
  if (isDefined(json.L4) && (json.L4 !== null)) str += "\n" + json.L4;
  return str;
}
