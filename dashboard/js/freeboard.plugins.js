function DialogBox(a, b, c, d, e) {
  ...
  h.append('<header><h2 class="title">' + b + "</h2></header>"), $(
    "<section></section>").appendTo(h).append(a);
  var i = $("<footer></footer>").appendTo(h);
  c &&
    $('<span id="dialog-ok" class="text-button">' + c + "</span>")
    .appendTo(i)
    .click(function() {
      var a = !1;
    ...
    d &&
    $('<span id="dialog-cancel" class="text-button">' + d + "</span>")
    .appendTo(i)
    .click(function() {
      f();
    }),
...
function FreeboardModel(a, b, c) {
  ...
  this.allow_edit.subscribe(function(a) {
    ...
    (this.datasourceData = {}),
    (this.processDatasourceUpdate = function(a, b) {
      var c = a.name();
      (d.datasourceData[c] = b),
      ...
      read: function() {
        ...
        return (
          _.each(a, function(a) {
            var c = a.type_name,
              d = c;
            _.isUndefined(a.display_name) || (d = a
              .display_name), b.push({
              name: c,
              display_name: d
            });
      ...
      read: function() {
        ...
        return (
          _.each(b, function(b) {
            var c = b.type_name,
              d = c;
            _.isUndefined(b.display_name) || (d = b
              .display_name), a.push({
              name: c,
              display_name: d
            });
    ...
    (this.serialize = function() {
      ...
      var b = [];
      return (
        _.each(d.datasources(), function(a) {
          b.push(a.serialize());
        }), {
          version: 1,
    ...
    (this.deserialize = function(e, f) {
      function g() {
        c.setUserColumns(e.columns),
          _.isUndefined(e.allow_edit) ? d.allow_edit(!0) : d
          .allow_edit(e.allow_edit),
          (d.version = e.version || 0),
          d.header_image(e.header_image),
        ...
        _.each(g, function(a) {
          ...
          d.allow_edit() && 0 == d.panes().length && d.setEditing(!
            0),
          _.isFunction(f) && f(),
          c.processResize(!0);
      }
      d.clearDashboard(),
        _.each(e.plugins, function(a) {
          d.addPluginSource(a);
        }),
        _.isArray(e.plugins) && e.plugins.length > 0 ?
        head.js(e.plugins, function() {
          g();
        }) :
        g();
    }),
    (this.clearDashboard = function() {
      c.removeAllPanes(),
        ...
        d.plugins.removeAll(),
        d.datasources.removeAll(),
        d.panes.removeAll();
    }),
    (this.loadDashboard = function(a, b) {
      c.showLoadingIndicator(!0),
        d.deserialize(a, function() {
          c.showLoadingIndicator(!1), _.isFunction(b) && b(),
    ...
    (this.saveDashboardClicked = function() {
      ...
      b ? $(event.currentTarget).siblings("label").fadeOut("slow") :
        $(event.currentTarget).siblings("label").fadeIn("slow"), a
        .data("siblings-shown", !b);
    }),
    (this.saveDashboard = function(a, b) {
      ...
      document.body.appendChild(f), (f.href = window.URL
        .createObjectURL(g)), (f.download = "dashboard.json"), (f
        .target = "_self"), f.click();
    }),
    (this.addDatasource = function(a) {
      d.datasources.push(a);
    }),
    (this.deleteDatasource = function(a) {
      delete d.datasourceData[a.name()], a.dispose(), d.datasources
        .remove(a);
    }),
    ...
    (this.setEditing = function(a, b) {
      if (d.allow_edit() || !a) {
        ...
        a
          ?
          ($("#toggle-header-icon").addClass("icon-chevron-up")
...
function FreeboardUI() {
    ...
    a &&
      (c = function(a) {
        var c = this,
          d = ko.dataFor(c),
          e = q(d);
        $(c).attr("data-sizex", Math.min(d.col_width(), b, r.cols))
          .attr("data-row", e.row).attr("data-col", e.col), d
          .processSizeChange();
      }),
      f(Math.min(b, w)),
      g(c),
    ...
    f(r.cols + 1) &&
      g(function() {
        ...
        a ? ((leftPreviewCol = !0), (b = {
          ...
          $(c).attr("data-sizex", Math.min(d.col_width(), r.cols))
          .attr("data-row", b.row).attr("data-col", b.col);
      }),
      d(),
      (w = r.cols);
  }
  ...
  function d() {
    var a = $(".column-tool"),
      ...
      c = Math.floor(b / v);
    r.cols <= u ? a.addClass("min") : a.removeClass("min"), r.cols >=
      c ? a.addClass("max") : a.removeClass("max");
  }
  ...
  function f(a) {
    ...
    a > b && (a = b);
    var c = v * a + a;
    return $(".responsive-column-width").css("max-width", c), a !== r
      .cols;
  }

  function g(a) {
    var b = r.$el;
    b.find("> li").unbind().removeData(), $(
        ".responsive-column-width").css("width", ""), r
      .generate_grid_and_stylesheet(), b.find("> li").each(a), r
      .init(), $(".responsive-column-width").css("width", r.cols * t +
        r.cols * s * 2);
  }
  ...
  function j(a, b, c) {
    ...
    r.add_widget(a, g, h, e, f),
      c && n(!0),
      l(b, f, e),
      $(a).attrchange({
        trackValues: !0,
        callback: function(a) {
          "data-row" == a.attributeName ? l(b, Number(a.newValue),
            void 0) : "data-col" == a.attributeName && l(b,
            void 0, Number(a.newValue));
        },
      });
  }
  ...
  function k(a, b) {
    ...
    (c == d && b.col_width() == e) ||
    r.resize_widget($(a), b.col_width(), c, function() {
  ...
  function l(a, b, c) {
    var d = r.cols;
    _.isUndefined(b) || (a.row[d] = b), _.isUndefined(c) || (a.col[
      d] = c);
  }

  function m(a) {
    a ? x.fadeOut(0).appendTo("body").fadeIn(500) : x.fadeOut(500)
      .remove();
  }
  ...
  function n(a, b) {
    _.isUndefined(b) && (b = !0);
    var c = b ? 250 : 0;
    a ? ($(".pane-tools").fadeIn(c), $("#column-tools").fadeIn(c)) : (
      $(".pane-tools").fadeOut(c), $("#column-tools").fadeOut(c));
  }
  ...
  function p(a, b) {
    b ? $(a).find(".sub-section-tools").fadeIn(250) : $(a).find(
      ".sub-section-tools").fadeOut(250);
  }
  ...
  function q(a) {
    ...
    if (_.isNumber(a.row) && _.isNumber(a.col)) {
      var c = {};
      (c[b] = a.row), (a.row = c), (c = {}), (c[b] = a.col), (a.col =
        c);
    }
    var d = 1,
      e = 1e3;
...
function PaneModel(a, b) {
  ...
  this.col_width.subscribe(function(a) {
      c.processSizeChange();
    }),
    ...
    (this.deserialize = function(d) {
      c.title(d.title),
        ...
        (c.row = d.row),
        (c.col = d.col),
        c.col_width(d.col_width || 1),
        _.each(d.widgets, function(d) {
...
function WidgetModel(a, b) {
  function c() {
    _.isUndefined(d.widgetInstance) || (_.isFunction(d.widgetInstance
      .onDispose) && d.widgetInstance.onDispose(), (d
  ...
  this.type.subscribe(function(a) {
      function e() {
        f.newInstance(d.settings(), function(a) {
          d.fillSize(!0 === f.fill_size), (d.widgetInstance =
            a), d.shouldRender(!0), d._heightUpdate
            .valueHasMutated();
        });
      }
      if ((c(), a in b && _.isFunction(b[a].newInstance))) {
        var f = b[a];
        f.external_scripts ? head.js(f.external_scripts.slice(0),
          e) : e();
      }
    }),
    (this.settings = ko.observable({})),
    this.settings.subscribe(function(a) {
      !_.isUndefined(d.widgetInstance) && _.isFunction(d
          .widgetInstance.onSettingsChanged) && d.widgetInstance
        .onSettingsChanged(a), d.updateCalculatedSettings(), d
        ._heightUpdate.valueHasMutated();
    }),
    ...
    (this.processSizeChange = function() {
      !_.isUndefined(d.widgetInstance) && _.isFunction(d
          .widgetInstance.onSizeChanged) && d.widgetInstance
        .onSizeChanged();
    }),
    (this.processCalculatedSetting = function(a) {
      if (_.isFunction(d.calculatedSettingScripts[a])) {
        ...
        if (!_.isUndefined(d.widgetInstance) && _.isFunction(d
            .widgetInstance.onCalculatedValueChanged) && !_
          .isUndefined(b))
          try {
    ...
    (this.updateCalculatedSettings = function() {
      if (((d.datasourceRefreshNotifications = {}), (d
          .calculatedSettingScripts = {}), !_.isUndefined(d
        .type()))) {
        ...
        _.each(a, function(a) {
          if ("calculated" == a.type) {
            var b = e[a.name];
            if (!_.isUndefined(b)) {
              _.isArray(b) && (b = "[" + b.join(",") + "]"), (b
                  .match(/;/g) || []).length <= 1 && -1 == b
                .indexOf("return") && (b = "return " + b);
              var f;
              try {
              ...
              (d.calculatedSettingScripts[a.name] = f), d
                .processCalculatedSetting(a.name);
              for (var h;
                (h = c.exec(b));) {
                var i = h[1] || h[2],
                  j = d.datasourceRefreshNotifications[i];
                _.isUndefined(j) && ((j = []), (d
                    .datasourceRefreshNotifications[i] = j)), -
                  1 == _.indexOf(j, a.name) && j.push(a.name);
              }
            }
          }
        });
    ...
    (this.height = ko.computed({
      read: function() {
        return d._heightUpdate(), !_.isUndefined(d
          .widgetInstance) && _.isFunction(d.widgetInstance
          .getHeight) ? d.widgetInstance.getHeight() : 1;
      },
    })),
    (this.shouldRender = ko.observable(!1)),
    (this.render = function(a) {
      d.shouldRender(!1), !_.isUndefined(d.widgetInstance) && _
        .isFunction(d.widgetInstance.render) && (d.widgetInstance
          .render(a), d.updateCalculatedSettings());
    }),
    (this.dispose = function() {}),
    (this.serialize = function() {
      return {
...
(DatasourceModel = function(a, b) {
  function c() {
    _.isUndefined(d.datasourceInstance) || (_.isFunction(d
        .datasourceInstance.onDispose) && d.datasourceInstance
      .onDispose(), (d.datasourceInstance = void 0));
  }
  var d = this;
  ...
  this.settings.subscribe(function(a) {
      !_.isUndefined(d.datasourceInstance) && _.isFunction(d
          .datasourceInstance.onSettingsChanged) && d
        .datasourceInstance.onSettingsChanged(a);
    }),
    ...
    (this.getDataRepresentation = function(a) {
      return new Function("data", "return " + a + ";").call(
        void 0, d.latestData());
    }),
    (this.updateNow = function() {
      !_.isUndefined(d.datasourceInstance) && _.isFunction(d
          .datasourceInstance.updateNow) && d.datasourceInstance
        .updateNow();
    }),
    (this.dispose = function() {
      c();
  ...
  function b() {
    function b(a) {
      var b = $("<tr></tr>"),
        ...
        f = $('<li><i class="icon-trash icon-white"></i></li>')
        .click(function(a) {
          (c = _.without(c, e)), b.remove();
        });
      c.push(e), a && e.val(a), d.append(f), g.append(b.append($(
        "<td></td>").append(e)).append($(
        '<td class="table-row-operation">').append(d)));
    }
    var c = [],
      d = $("<div></div>"),
    ...
    f.append(g),
      ...
      new DialogBox(d, "Developer Console", "OK", null, function() {
        _.each(a.plugins(), function(a) {
          ...
          _.each(c, function(b) {
            var c = b.val();
            c && c.length > 0 && (a.addPluginSource(c), head.js(
              c + "?" + Date.now()));
          });
      });
  }
...
(PluginEditor = function(a, b) {
  ...
  function f(c, d, e, f, g) {
    ...
    var k = $(
      ...
      a.preventDefault(), $(h).val("").focus().insertAtCaret(
        'datasources["').trigger("freeboard-eval");
    });
    i.append(k);
    var l = $(
      ...
      b.preventDefault(),
        a.displayJSEditor(h.val(), function(a) {
          h.val(a), h.change();
        });
    });
    if ((i.append(l), g)) {
      var m = $(
        ...
        a.preventDefault(), j.remove(), $(c).find(
  ...
  function g(a, b, g, h, i) {
    function j(a, b) {
      var c = $('<div id="setting-row-' + a +
        '" class="form-row"></div>').appendTo(n);
      return c.append(
        '<div class="form-label"><label class="control-label">' +
        b + "</label></div>"), $(
        '<div id="setting-value-container-' + a +
        '" class="form-value"></div>').appendTo(c);
    }
      ...
      _.each(a, function(a) {
        ...
        function e(b) {
          var c = $("<tr></tr>").appendTo(p),
            e = {};
          _.isArray(m.settings[a.name]) || (m.settings[a
              .name] = []),
            m.settings[a.name].push(e),
            _.each(a.settings, function(a) {
              var d = $("<td></td>").appendTo(c),
                f = "";
              _.isUndefined(b[a.name]) || (f = b[a.name]),
                (e[a.name] = f),
                $(
              ...
              $('<td class="table-row-operation"></td>').append(
                $('<ul class="board-toolbar"></ul>').append(
                  $("<li></li>").append(
                    ...
                    .click(function() {
                      var b = m.settings[a.name].indexOf(e); -
                      1 != b && (m.settings[a.name].splice(b,
                        1), c.remove(), d());
                    })
                  )
                )
            ...
            d();
        }!_.isUndefined(a.default_value) && _.isUndefined(h[a
          .name]) && (h[a.name] = a.default_value);
        var g = a.name;
        ...
        switch (a.type) {
          case "array":
            ...
            _.each(a.settings, function(a) {
                var b = a.name;
                _.isUndefined(a.display_name) || (b = a
                    .display_name), $("<th>" + b + "</th>")
                  .appendTo(o);
              }),
              a.name in h && (q = h[a.name]),
              $(
                '<div class="table-operation text-button">ADD</div>')
              .tw -
              value.appendTo(i).click(function() {
                var b = {};
                _.each(a.settings, function(a) {
                    b[a.name] = "";
                  }),
          ...
          case "option":
            ...
            _.each(a.options, function(a) {
                var b, c;
                _.isObject(a) ? ((b = a.name), (c = a
                  .value)) : (b = a), _.isUndefined(c) && (c =
                    b), _.isUndefined(t) && (t = c), $(
                    "<option></option>").text(b).attr("value",
                    c).appendTo(s);
              }),
              (m.settings[a.name] = t),
              a.name in h && s.val(h[a.name]);
            break;
          default:
            if (((m.settings[a.name] = h[a.name]),
                "calculated" == a.type)) {
              if (a.name in h) {
                var u = h[a.name];
                if (a.multi_input && _.isArray(u))
                  for (var v = !1, w = 0; w < u.length; w++) f(
                    i, m, a, u[w], v), (v = !0);
                else f(i, m, a, u, !1);
              } else f(i, m, a, null, !1);
              if (a.multi_input) {
              ...
              var s = $('<input type="text">')
                .appendTo(i)
                .change(function() {
                  "number" == a.type ? (m.settings[a.name] =
                    Number($(this).val())) : (m.settings[a
                    .name] = $(this).val());
                });
              if ((a.name in h && s.val(h[a.name]), b && a
                  .typeahead_data_field && s.addClass(
                    "typeahead_data_field-" + a
                    .typeahead_data_field), b && a
                  .typeahead_field)) {
                var y = [];
                s.keyup(function(a) {
                    a.which >= 65 && a.which <= 91 && s
                      .trigger("change");
                  }),
                  $(s).autocomplete({
                    source: y,
                    select: function(a, b) {
                      s.val(b.item.value), s.trigger(
                        "change");
                    },
                  }),
                  s.change(function(d) {
        ...
        _.isUndefined(a.suffix) || i.append($(
          '<div class="input-suffix">' + a.suffix + "</div>"
          )), _.isUndefined(a.description) || i.append($(
          '<div class="setting-description">' + a
          .description + "</div>"));
      });
    }
    var l,
    ...
    n.append(o),
      new DialogBox(n, a, "Save", "Cancel", function() {
        $(".validation-error").remove();
        for (var a = 0; a < l.settings.length; a++) {
          var b = l.settings[a];
          if (b.required && (_.isUndefined(m.settings[b.name]) ||
              "" == m.settings[b.name])) return c(b.name,
            "This is required."), !0;
    ...
    if (q.length > 1) {
      ...
      (p = $("<select></select>").appendTo($(
        '<div class="styled-select"></div>').appendTo(r))),
      p.append($("<option>Select a type...</option>").attr("value",
          "undefined")),
        _.each(b, function(a) {
          p.append($("<option></option>").text(a.display_name)
            .attr("value", a.type_name));
        }),
        p.change(function() {
          (m.type = $(this).val()),
          (m.settings = {}),
          d(),
            ...
            ($("#setting-row-instance-name").show(),
              l.description && l.description.length > 0 ? o.html(l
                .description).show() : o.hide(),
              $("#dialog-ok").show(),
              k(l.settings, l.typeahead_source, l
                .typeahead_data_segment));
        });
    } else 1 == q.length && ((l = b[q[0]]), (m.type = l.type_name),
      (m.settings = {}), k(l.settings));
    p && (_.isUndefined(g) ? ($("#setting-row-instance-name")
    .hide(), $("#dialog-ok").hide()) : ($("#dialog-ok").show(),
      p.val(g).trigger("change")));
  }
  return {
...
(ValueEditor = function(a) {
  ...
  function d(a, b) {
    $(a).parent().find(".validation-error").remove(),
      c(n, b) ||
      $(a)
      .parent()
      .append(
        "<div class='validation-error'>This field expects an expression that evaluates to type " +
        b + ".</div>");
  }
    ...
    if (e)
      ...
      if (!_.isUndefined(h)) {
        ...
        if (!_.isUndefined(e[2])) {
          ...
          (i += e[3].substring(0, l)), (k = e[3].substring(l, e[3]
            .length)), (k = k.replace(/^[\[\"]*/, "")), (k = k
            .replace(/[\"\]]*$/, ""));
        }
  ...
  function g(b, c) {
    ...
    if (((e = e.replace(String.fromCharCode(160), " ")), f(e, a
        .datasources(), c), m.length > 0)) {
      k ||
        (k = $(
            '<ul id="value-selector" class="value-dropdown"></ul>')
          .insertAfter(b)
          .width($(b).outerWidth() - 2)
          .css("left", $(b).position().left)
          .css("top", $(b).position().top + $(b).outerHeight() - 1)
          ),
        k.empty(),
        k.scrollTop(0);
      var g = !0;
      (l = 0),
      _.each(m, function(a, c) {
        var d = h(b, e, a, c);
        g && ($(d).addClass("selected"), (g = !1));
      });
    } else d(b, c), $(b).next("ul#value-selector").remove(), (k =
      null), (l = -1);
  }
  ...
  function h(a, b, c, d) {
    var e = c.value;
    return (
      c.preview && (e = e + "<span class='preview'>" + c.preview +
        "</span>"),
      $("<li>" + e + "</li>")
      .appendTo(k)
      .mouseenter(function() {
  ...
  function i(a, b) {
    $(a)
      ...
      .bind("keyup mouseup freeboard-eval", function(c) {
        if (k && "keyup" == c.type && (38 == c.keyCode || 40 == c
            .keyCode || 13 == c.keyCode)) return void c
          .preventDefault();
        g(a, b);
      })
      .focus(function() {
      ...
      .focusout(function() {
        d(a, b), $(a).css({
            height: "",
            "z-index": 3e3
          }), $(a).next("ul#value-selector").remove(), (k = null),
          (l = -1);
      })
      .bind("keydown", function(a) {
        if (k)
          if (38 == a.keyCode || 40 == a.keyCode) {
            a.preventDefault();
            var b = $(k).find("li");
            38 == a.keyCode ? l-- : 40 == a.keyCode && l++, l <
              0 ? (l = b.size() - 1) : l >= b.size() && (l = 0);
            var c = $(b).eq(l);
            c.trigger("freeboard-select"), $(k).scrollTop($(c)
              .position().top);
          } else 13 == a.keyCode && (a.preventDefault(), -1 !=
            l && $(k).find("li").eq(l).trigger(
...
(function(a) {
  ...
  function c(b, c) {
    if (b) {
      ...
      if (c.attributeName.indexOf("style") >= 0) {
        ...
        (c.attributeName = e[0]), (c.oldValue = d.style[e[1]]), (c
          .newValue = e[1] + ":" + this.prop("style")[a.camelCase(e[
            1])]), (d.style[e[1]] = c.newValue);
      } else(c.oldValue = d[c.attributeName]), (c.newValue = this
        .attr(c.attributeName)), (d[c.attributeName] = c.newValue);
  ...
  a.fn.attrchange = function(e) {
    ...
    if (
      ("function" == typeof e ? (f.callback = e) : a.extend(f, e),
        f.trackValues &&
        a(this).each(function(b, c) {
          for (var d, e = {}, b = 0, f = c.attributes, g = f
              .length; b < g; b++)(d = f.item(b)), (e[d
            .nodeName] = d.value);
      ...
      var g = {
        ...
        h = new d(function(b) {
          b.forEach(function(b) {
            var c = b.target;
            f.trackValues && (b.newValue = a(c).attr(b
              .attributeName)), f.callback.call(c, b);
          });
        });
    ...
    return b() ?
      this.on("DOMAttrModified", function(a) {
        a.originalEvent && (a = a.originalEvent), (a
          .attributeName = a.attrName), (a.oldValue = a
          .prevValue), f.callback.call(this, a);
      }) :
      "onpropertychange" in document.body ?
      this.on("propertychange", function(b) {
        (b.attributeName = window.event.propertyName), c.call(a(
          this), f.trackValues, b), f.callback.call(this, b);
      }) :
      this;
  };
})(jQuery),
  ...
  return (
    (ko.bindingHandlers.pluginEditor = {
      init: function(a, f, g, i, j) {
        var k = ko.unwrap(f()),
          ...
          m = void 0,
          n = "";
        "datasource" == k.type ? ((l = b), (n =
            "Datasource")) : "widget" == k.type ? ((l = c),
            (n = "Widget")) : "pane" == k.type && (n =
            "Pane"),
          $(a).click(function(f) {
            if ("delete" == k.operation) {
              new DialogBox($(
                  "<p>Are you sure you want to delete this " +
                  n + "?</p>"), "Confirm Delete", "Yes",
                "No",
                function() {
                  "datasource" == k.type ? e
                    .deleteDatasource(i) : "widget" == k
                    .type ? e.deleteWidget(i) :
                    "pane" == k.type && e.deletePane(i);
                });
            } else {
              var g = void 0;
              "datasource" == k.type ?
                "add" == k.operation ?
                (m = {}) :
                ((g = i.type()), (m = i.settings()), (m
                  .name = i.name())) :
                "widget" == k.type ?
                "add" == k.operation ?
                (m = {}) :
                ((g = i.type()), (m = i.settings())) :
                "pane" == k.type &&
                ((m = {}),
                  "edit" == k.operation && ((m.title = i
                    .title()), (m.col_width = i
                    .col_width())),
                  (l = {
                    settings: {
                ...
                h.createPluginEditor(n, l, g, m, function(
                  f) {
                  if ("add" == k.operation) {
                    if ("datasource" == k.type) {
                      var g = new DatasourceModel(e, b);
                      e.addDatasource(g), g.name(f
                          .settings.name), delete f
                        .settings.name, g.settings(f
                          .settings), g.type(f.type);
                    } else if ("widget" == k.type) {
                      var g = new WidgetModel(e, c);
                      g.settings(f.settings), g.type(f
                          .type), i.widgets.push(g), d
                        .attachWidgetEditIcons(a);
                    }
                  } else "edit" == k.operation && (
                    "pane" == k.type ? (i.title(f
                        .settings.title), i.col_width(
                        f.settings.col_width), d
                      .processResize(!1)) : (
                      "datasource" == k.type && (i
                        .name(f.settings.name),
                        delete f.settings.name), i
                      .type(f.type), i.settings(f
                        .settings)));
                });
            }
          });
    ...
    (ko.bindingHandlers.pane = {
      ...
      update: function(a, b, c, f, g) {
        -1 == e.panes.indexOf(f) && d.removePane(a), d
          .updatePane(a, f);
      },
    }),
    (ko.bindingHandlers.widget = {
      init: function(a, b, c, f, g) {
        e.isEditing() && d.attachWidgetEditIcons($(a)
          .parent());
      },
      update: function(a, b, c, d, e) {
    ...
    $(function() {
      ...
      initialize: function(b, c) {
        ...
        "" != f
          ...
          (e.allow_edit(b), e.setEditing(b), d
            .showLoadingIndicator(!1), _.isFunction(c) && c(),
      ...
      loadDatasourcePlugin: function(a) {
        _.isUndefined(a.display_name) && (a.display_name = a
            .type_name),
          a.settings.unshift({
            name: "name",
            display_name: "Name",
          ...
          e.addPluginSource(a.source),
          (b[a.type_name] = a),
          e._datasourceTypes.valueHasMutated();
      },
      resize: function() {
        d.processResize(!0);
      },
      loadWidgetPlugin: function(a) {
        _.isUndefined(a.display_name) && (a.display_name = a
          .type_name), e.addPluginSource(a.source), (c[a
          .type_name] = a), e._widgetTypes.valueHasMutated();
      },
      ...
      addStyle: function(a, b) {
        var c = a + "{" + b + "}",
          d = $("style#fb-styles");
        0 == d.length && ((d = $(
          '<style id="fb-styles" type="text/css"></style>'
          )), $("head").append(d)), d[0].styleSheet ? (d[0]
          .styleSheet.cssText += c) : d.text(d.text() + c);
      },
      showLoadingIndicator: function(a) {
...
$.extend(freeboard, jQuery.eventEmitter),
  (function() {
      ...
      c(1e3 * f.refresh),
        (this.updateNow = function() {
          if (!((g > 1 && !f.use_thingproxy) || g > 2)) {
            var a = f.url;
            2 == g && f.use_thingproxy && (a = ("https:" ==
                location.protocol ? "https:" : "http:") +
              "//thingproxy.freeboard.io/fetch/" + encodeURI(f
                .url));
            var c = f.body;
            if (c)
              try {
              ...
              beforeSend: function(a) {
                try {
                  _.each(f.headers, function(b) {
                    var c = b.name,
                      d = b.value;
                    _.isUndefined(c) || _.isUndefined(
                      d) || a.setRequestHeader(c, d);
                  });
                } catch (a) {}
              },
              success: function(a) {
        ...
        (this.updateNow = function() {
          $.ajax({
            url: "http://api.openweathermap.org/data/2.5/weather?APPID=" +
              g.api_key + "&q=" + encodeURIComponent(g
                .location) + "&units=" + g.units,
            dataType: "JSONP",
            success: function(a) {
              var c = {
                place_name: a.name,
                sunrise: new Date(1e3 * a.sys.sunrise)
                  .toLocaleTimeString(),
                sunset: new Date(1e3 * a.sys.sunset)
                  .toLocaleTimeString(),
    ...
    var d = function(a, b) {
      function c() {
        h.length > 0 ? (i < h.length && (b(h[i]), i++), i >= h
          .length && g.loop && (i = 0), i < h.length && (e =
            setTimeout(c, 1e3 * g.refresh))) : b({});
      }
  ...
  (function() {
      ...
      if (d != a)
        if ($.isNumeric(a) && $.isNumeric(d)) {
          var e = a.toString().split("."),
            f = 0;
          e.length > 1 && (f = e[1].length), (e = d.toString()
            .split("."));
          var g = 0;
          e.length > 1 && (g = e[1].length),
            jQuery({
              ...
              duration: c,
              step: function() {
                $(b).text(this.transitionValue.toFixed(this
                  .precisionValue));
              },
              done: function() {
                $(b).text(a);
    ...
    function b(a, b) {
      for (var c = $("<div class='sparkline-legend'></div>"), d =
        0; d < b.length; d++) {
        var f = e[d % e.length],
          g = b[d];
        c.append(
    ...
    function c(a, b, c) {
      ...
      var i = function(a, b) {
        f[b] || (f[b] = []), f[b].length >= d && f[b].shift(), f[
            b].push(Number(a)), (void 0 === g || a < g) && (g =
          a), (void 0 === h || a > h) && (h = a);
      };
      _.isArray(b) ? _.each(b, i) : i(b, 0), ($(a).data().values =
        f), ($(a).data().valueMin = g), ($(a).data().valueMax = h);
    ...
    var d = 100,
      e = ["#FF9900", "#FFFFFF", "#B3B4B4", "#6B6B6B", "#28DE28",
        "#13F7F9", "#E6EE18", "#C41204", "#CA3CB8", "#0B1CFB"
      ],
      f = freeboard.getStyleString("values");
    freeboard.addStyle(".widget-big-text", f + "font-size:75px;"),
      freeboard.addStyle(".tw-display",
      ...
      freeboard.addStyle(".tw-value", f +
        "font-family: Poppins;overflow: hidden;display: inline-block;text-overflow: ellipsis;white-space: pre-wrap;"
        ),
    ...
    var g = function(b) {
      function d() {
        _.isUndefined(e.units) || "" == e.units ? h.css(
          "max-width", "100%") : h.css("max-width", f
          .innerWidth() - i.outerWidth(!0) + "px");
      }
      var e = b,
      ...
      (this.render = function(a) {
        $(a).empty(),
          $(f)
          .append($('<div class="tw-tr"></div>').append(g))
          .append($('<div class="tw-tr"></div>').append($(
              '<div class="tw-value-wrapper tw-td"></div>')
            .append(h).append(i)))
          .append($('<div class="tw-tr"></div>').append(j)),
          $(a).append(f),
          d();
      }),
      (this.onSettingsChanged = function(a) {
        ...
        a.sparkline ? j.attr("style", null) : (delete j.data()
            .values, j.empty(), j.hide()),
          b ? (g.html(_.isUndefined(a.title) ? "" : a.title), g
            .attr("style", null)) : (g.empty(), g.hide()),
          c ? (i.html(_.isUndefined(a.units) ? "" : a.units), i
            .attr("style", null)) : (i.empty(), i.hide());
        var f = 30;
        "big" == a.size && ((f = 75), a.sparkline && (f = 60)),
          h.css({
            "font-size": f + "px"
          }), d();
      }),
      ...
      (this.onCalculatedValueChanged = function(b, d) {
        "value" == b && (e.animate ? a(d, h, 500) : h.text(d), e
          .sparkline && c(j, d));
      }),
      (this.onDispose = function() {}),
    ...
    var h = 0;
    freeboard.addStyle(".gauge-widget-wrapper",
      "width: 100%;text-align: center;"), freeboard.addStyle(
      ".gauge-widget",
    ...
    var i = function(a) {
      function b() {
        g &&
          (f.empty(),
            (c = new JustGage({
              id: d,
              value: _.isUndefined(i.min_value) ? 0 : i
                .min_value,
              min: _.isUndefined(i.min_value) ? 0 : i
                .min_value,
              max: _.isUndefined(i.max_value) ? 0 : i
                .max_value,
              label: i.units,
              showInnerShadow: !1,
      ...
      var c,
        ...
        i = a;
      (this.render = function(a) {
        (g = !0), $(a).append(e).append($(
            '<div class="gauge-widget-wrapper"></div>')
          .append(f)), b();
      }),
      (this.onSettingsChanged = function(a) {
        a.min_value != i.min_value || a.max_value != i
          .max_value || a.units != i.units ? ((i = a), b()) : (
            i = a), e.html(a.title);
      }),
    ...
    var j = function(a) {
      ...
      (this.onSettingsChanged = function(a) {
        (g = a), d.html(_.isUndefined(a.title) ? "" : a.title),
    ...
    freeboard.loadWidgetPlugin({
      ...
      freeboard.addStyle("div.pointer-value",
    ...
    var k = function(a) {
      function b(a) {
        ...
        var b = [];
        b.push(["m", a[0], a[1]]);
        for (var c = 2; c < a.length; c += 2) b.push(["l", a[c],
          a[c + 1]
        ]);
        return b.push(["z"]), b;
      }
      ...
      (this.render = function(a) {
        ...
        k.attr("stroke", "#FF9900"),
          k.attr("stroke-width", g),
          (d = c.path(b([e / 2, f / 2 - h + g, 15, 20, -30,
            0]))),
          d.attr("stroke-width", 0),
          d.attr("fill", "#fff"),
          $(a).append($('<div class="pointer-value"></div>')
            .append(i).append(j));
      }),
      (this.onSettingsChanged = function(a) {
        j.html(a.units);
    ...
    var l = function(a) {
      ...
      (this.onSettingsChanged = function(a) {
        b(), a.refresh && a.refresh > 0 && (e = setInterval(c,
          1e3 * Number(a.refresh)));
      }),
      (this.onCalculatedValueChanged = function(a, b) {
        "src" == a && (f = b), c();
      }),
    ...
    freeboard.loadWidgetPlugin({
      ...
      freeboard.addStyle(".indicator-light",
    ...
    var m = function(a) {
      function b() {
        ...
        g.toggleClass("on", i), i ? f.text(_.isUndefined(c) ? (_
          ...
          .text(_.isUndefined(d) ? (_.isUndefined(h.off_text) ?
            "" : h.off_text) : d);
      }
      var c,
        d,
      ...
      (this.onSettingsChanged = function(a) {
        (h = a), e.html(_.isUndefined(a.title) ? "" : a.title),
          b();
      }),
      (this.onCalculatedValueChanged = function(a, e) {
        "value" == a && (i = Boolean(e)), "on_text" == a && (c =
          e), "off_text" == a && (d = e), b();
      }),
      (this.onDispose = function() {}),
      (this.getHeight = function() {
    ...
    var n = function(a) {
      ...
      (this.render = function(a) {
        function e() {
          var e = {
            zoom: 13,
            center: new google.maps.LatLng(37.235, -
              115.811111),
            disableDefaultUI: !0,
            draggable: !1,
            styles: [{
          ...
          (c = new google.maps.Map(a, e)),
          google.maps.event.addDomListener(a, "mouseenter",
              function(a) {
                (a.cancelBubble = !0), c.hover || ((c.hover = !
                  0), c.setOptions({
                  zoomControl: !0
                }));
              }),
            google.maps.event.addDomListener(a, "mouseleave",
              function(a) {
        ...
        window.google && window.google.maps ? e() : ((window
          .gmap_initialize = e), head.js(
    ...
    freeboard.loadWidgetPlugin({
      ...
      freeboard.addStyle(".html-widget",
