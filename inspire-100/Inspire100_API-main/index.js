...
app.use('/inspire100',messageRoute);
...
const options = {
    key: fs.readFileSync('./ssl/tekmedika.com.key'), 
    cert: fs.readFileSync('./ssl/tekmedika.com.crt') ,
    ca: fs.readFileSync('./ssl/tekmedika.com.ca-bundle')
};
